...
MRuby::Build.new do |conf|
  ...
  conf.gem mgem: 'mruby-hashie', checksum_hash: 'bfdbb8aebc8786bc9e88469dae87a8dfe8ec4300' # Specified by mitamae
  conf.gem mgem: 'mruby-io', checksum_hash: '86d58a2d3727f556e6e6ce10d170b6170911a263' # Specified by mitamae
  # conf.gem mgem: 'mruby-open3', checksum_hash: '211550775492e68ba217526808cf1df9deb7fa5a' # Specified by mitamae
  conf.gem github: 'sorah/mruby-open3', checksum_hash: 'origin/fixbuf' #  https://github.com/k0kubun/mruby-open3/pull/9
  conf.gem mgem: 'mruby-shellwords', checksum_hash: '2a284d99b2121615e43d6accdb0e4cde1868a0d8' # Specified by mitamae
  conf.gem mgem: 'mruby-specinfra', checksum_hash: '22a54436fe53afd310ad4473d28edd03dd960a24' # Specified by mitamae
  ...
  if ENV['PORTAGE_ENABLE_MITAMAE_SECRETS']
	  conf.gem github: 'eagletmt/mitamae-secrets', checksum_hash: 'v0.1.1'
  end

  if ENV['PORTAGE_ENABLE_MGEM_MRUBY_IPADDR']
